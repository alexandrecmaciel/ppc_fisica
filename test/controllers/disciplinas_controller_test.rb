...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { bib_basica: @disciplina.bib_basica, bib_complementar: @disciplina.bib_complementar, ch: @disciplina.ch, ementa: @disciplina.ementa, titulo: @disciplina.titulo, usuario_id: @disciplina.usuario_id } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { bib_basica: @disciplina.bib_basica, bib_complementar: @disciplina.bib_complementar, ch: @disciplina.ch, ementa: @disciplina.ementa, titulo: @disciplina.titulo, usuario_id: @disciplina.usuario_id } }
